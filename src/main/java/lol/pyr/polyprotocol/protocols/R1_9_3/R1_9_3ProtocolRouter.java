package lol.pyr.polyprotocol.protocols.R1_9_3;
...
public class R1_9_3ProtocolRouter extends ProtocolRouter {
    private static final ProtocolVersion version = ProtocolVersion.R1_9_3;

    public R1_9_3ProtocolRouter() {
        super(version);
