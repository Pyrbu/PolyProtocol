package lol.pyr.polyprotocol.protocols.R1_14;
...
public class R1_14ProtocolRouter extends ProtocolRouter {
    private static final ProtocolVersion version = ProtocolVersion.R1_14;

    public R1_14ProtocolRouter() {
        super(version);
