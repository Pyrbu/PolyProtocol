package lol.pyr.polyprotocol.protocols.R1_9_2;
...
public class R1_9_2ProtocolRouter extends ProtocolRouter {
    private static final ProtocolVersion version = ProtocolVersion.R1_9_2;

    public R1_9_2ProtocolRouter() {
        super(version);
