package lol.pyr.polyprotocol.protocols.R1_9_1;
...
public class R1_9_1ProtocolRouter extends ProtocolRouter {
    private static final ProtocolVersion version = ProtocolVersion.R1_9_1;

    public R1_9_1ProtocolRouter() {
        super(version);
