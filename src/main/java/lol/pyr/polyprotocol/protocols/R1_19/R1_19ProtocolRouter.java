package lol.pyr.polyprotocol.protocols.R1_19;
...
public class R1_19ProtocolRouter extends ProtocolRouter {
    private static final ProtocolVersion version = ProtocolVersion.R1_19;

    public R1_19ProtocolRouter() {
        super(version);
