...
public class R1_7_2ProtocolRouter extends ProtocolRouter {
    ...
    public R1_7_2ProtocolRouter() {
        super(ProtocolVersion.R1_7_2);
        registerDecoder(PacketDirection.CLIENTBOUND, ProtocolState.LOGIN, 0x01, buffer -> new R1_7_2ClientboundEncryptionRequestPacket(ProtocolVersion.R1_7_2, buffer));
        registerDecoder(PacketDirection.CLIENTBOUND, ProtocolState.LOGIN, 0x02, buffer -> new CommonClientboundLoginSuccessPacket(ProtocolVersion.R1_7_2, buffer));
    }
}
